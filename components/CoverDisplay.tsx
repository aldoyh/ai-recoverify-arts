...
export const CoverDisplay: React.FC<CoverDisplayProps> = ({ data, title, downloadButtonText, summaryLabel, promptLabel, urlLabel, metadataNoticeText }) => {
    return (
        <section className="mt-12 bg-slate-800/60 backdrop-blur-sm rounded-xl shadow-2xl p-6 md:p-8 border border-slate-600 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-4">
                    <div>
                        <h3 className="text-lg font-semibold text-slate-100">{summaryLabel}</h3>
                        <p className="text-slate-200 bg-slate-900/50 p-3 rounded-md mt-1">"{data.summary}"</p>
                    ...
                    <div>
                        <h3 className="text-lg font-semibold text-slate-100">{promptLabel}</h3>
                        <p className="text-slate-200 bg-slate-900/50 p-3 rounded-md mt-1 italic">"{data.prompt}"</p>
                    </div>
                     <div>
                        <h3 className="text-lg font-semibold text-slate-100">{urlLabel}</h3>
