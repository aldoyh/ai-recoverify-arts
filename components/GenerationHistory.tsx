    ...
    return (
        <section className="mt-12 bg-slate-800/60 backdrop-blur-sm rounded-xl shadow-2xl p-6 md:p-8 border border-slate-600 animate-fade-in">
            ...
            <div className="space-y-4 max-h-96 overflow-y-auto pe-2">
                {history.map((item) => (
                    <div key={item.id} className="flex items-center gap-4 bg-slate-900/50 p-3 rounded-lg">
                        ...
                        <div className="overflow-hidden">
                            <p className="text-sm font-semibold text-slate-100 truncate" title={item.prompt}>
