    ...
    return (
        <div>
            ...
            <label
                ...
                className="flex justify-center items-center w-full h-48 border-2 border-dashed border-red-600 rounded-lg cursor-pointer bg-brand-red-900/50 hover:bg-brand-red-900/80 transition duration-300"
